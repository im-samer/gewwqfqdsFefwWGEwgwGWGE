...
bot('sendmessage',[ 
'chat_id'=>$chat_id,
'text'=>" اهلا بك عزيز \n تشيكر التنصيب بوت يمكنك تواصل ع الاسفل اليوزرات
...
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"⌁ Done Stoped Checker \n⌁ Checker Stoped List ".$ex[1]." 🔐",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],]])]);
$info = json_decode(file_get_contents('info.json'),true);
$info["num".$ex[1]] = "off";
file_put_contents('info.json', json_encode($info));
}
...
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"Send List ".$ex[1]." 📥",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],]])]);
file_put_contents('mode', 'besso'.$ex[1]);
}
if (preg_match('/Delet - \d+/',$text)){
$ex = explode('Delet - ',$text);
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"Delet List ".$ex[1]." 🗑",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],]])]);
...
$EzTG->sendMessage(['chat_id'=>$cha,'text'=>"⌁ Done Delet User List 2 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
} else {
...
bot('sendMessage', ['chat_id' => $chat_id,  'text' => "⌁ Done Delet User List 1 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
unlink('mode');
}elseif($mode == 'besso1'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 2 : @$user" ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
unlink('mode');
}elseif($mode == 'besso2'){
echo $mode;
...
$EzTG->sendMessage(['chat_id'=>$cha,'text'=>"@$user : ⌁ Done Pin.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
} else {
bot('sendMessage', ['chat_id' => $chat_id, 'text'=>"@$user : Already Exists.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);}
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 3 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
unlink('mode');
}elseif($mode == 'besso3'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 4 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
unlink('mode');
}elseif($mode == 'besso4'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 5 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => " dev", 'url' => "https://t.me/samer_ls"]],
]])]);
unlink('mode');
}elseif($mode == 'besso5'){
echo $mode;
